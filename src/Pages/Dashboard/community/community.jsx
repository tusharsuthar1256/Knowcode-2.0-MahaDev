...
{/* <div className={`text-gray-600 body-font flex justify-end  ${
          isExpand ? ' w-[calc(100%-20rem)] ' : ' w-[calc(100%-5rem)] ' 
        }`} > */}
<section class={`text-gray-600 body-font flex justify-end  ${
          isExpand ? 'ml-75 w-[calc(100%-20rem)] ' : 'ml-20 w-[calc(100%-5rem)] ' 
        }`}>
